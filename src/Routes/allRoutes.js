...
// add Real estate and Driver search routes
import RealEstate from "../pages/Pages/Real_estate/RealEstate";
import DriverSearch from "../pages/Pages/Driver_search/DriverSearch";
...
import RangeAreaChart from "../pages/Charts/ApexCharts/RangeAreaCharts";
...
const authProtectedRoutes = [
  ...
  { path: "/pages-real-estate", component: <RealEstate /> },
  { path: "/pages-driver-search", component: <DriverSearch /> },
